    ...
    return (
        ...
        <section className="bg-black  text-white flex flex-col md:flex-row gap-10 md:px-20 py-32 px-8">
            ...
            <div className="w-full md:w-1/2">
                <h2 className="md:text-6xl text-4xl md:text-start text-center font-fancy mb-8">Preguntas Frecuentes</h2>
                <p className="md:text-2xl text-base font-simple">Aqui esta una lista de las preguntas más comunes que suelen tener mis clientes, no dudes contactarme para cualquier consulta adicional.</p>
            </div>
