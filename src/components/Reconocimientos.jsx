...
export default function Reconocimientos() {
    ...
    return <section className="bg-black text-white pt-30 pb-10 px-4 flex flex-col gap-8 items-start justify-center md:gap-16">
        ...
        >
            <h2 className="font-fancy md:text-5xl text-5xl text-center pb-4">Premios</h2>
        ...
        <div className={` md:px-20 w-full px-6 transition-all duration-700
            ...
            <div className={isSpread ? 'md:w-80 md:z-3 z-5' : 'absolute left-1/2 md:left-[40%] top-1/2 md:top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80%] md:z-3 z-5'}>
                <Prize onClick={handleToggle} image={premio1} title="Primer Lugar Color 🥇" description='Expotattoo Altos Mirandinos 2024' />
            </div>
            <div className={isSpread ? 'md:w-80 md:z-5 z-4' : 'absolute left-1/2 md:left-1/2 top-[60%] md:top-[55%] transform -translate-x-1/2 -translate-y-1/2 w-[80%] md:z-5 z-4'}>
                <Prize onClick={handleToggle} image={premio3} title="Segundo Lugar Color 🥈" description='Expotattoo Altos Mirandinos 2023' />
            </div>
            <div className={isSpread ? 'md:w-80 md:z-3 z-3' : 'absolute left-1/2 md:left-[60%] top-[65%] md:top-[50%] transform -translate-x-1/2 -translate-y-1/2 w-[80%] md:z-3 z-3'}>
